...
#define POLARSSL_ECP_SM2_ENABLED
/**
 ...
 *          library/ssl_srv.c
 *
 * This module adds support for SM3
 */
#define POLARSSL_SM3_C
...
#define POLARSSL_PKCS7_C
#define POLARSSL_PKCS7_DATA_C
#define POLARSSL_PKCS7_SIGNED_DATA_C
