...
#define OID_PKCS7_DATA                   OID_PKCS7 "\x01"       /** <data OBJECT IDENTIFIER ::= { pkcs-7 1 } */
#define OID_PKCS7_SIGNED_DATA            OID_PKCS7 "\x02"       /** <signedData OBJECT IDENTIFIER ::= { pkcs-7 2 } */
#define OID_PKCS7_ENVELOPED_DATA         OID_PKCS7 "\x03"       /** <envelopedData OBJECT IDENTIFIER ::= { pkcs-7 3 } */
#define OID_PKCS7_SIGNED_ENVELOPED_DATA  OID_PKCS7 "\x04"       /** <signedAndEnvelopedData OBJECT IDENTIFIER ::= { pkcs-7 4 } */
#define OID_PKCS7_DIGESTED_DATA          OID_PKCS7 "\x05"       /** <digestedData OBJECT IDENTIFIER ::= { pkcs-7 5 } */
#define OID_PKCS7_ENCRYPTED_DATA         OID_PKCS7 "\x06"       /** <encryptedData OBJECT IDENTIFIER ::= { pkcs-7 6 } */
